...
- [x] [Workflows] Promote `codexkit-parity` as the canonical shared parity workflow and keep `surfacekit-sync` only as a compatibility alias during the rename wave.
